...
let num1 = 5; // Biến num1 kiểu number
let num2 = 3; // Biến num2 kiểu number
let num3; // Biến num3 kiểu number
let num4 = "10"; // Biến num4 kiểu string
let num5 = true; // Biến num5 kiểu boolean
